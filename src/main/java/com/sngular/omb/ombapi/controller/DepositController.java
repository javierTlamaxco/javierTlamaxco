...
public class DepositController {
    ...
    public ResponseEntity<DepositResponse> postDeposit(@PathVariable String accountId, @RequestBody DepositRequest depositRequest) throws ExceptionFormat {
        return new ResponseEntity(depositService.makeDeposit(accountId,depositRequest), HttpStatus.OK);
    }
}
